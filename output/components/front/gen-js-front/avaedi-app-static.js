...
Ext.apply(At4FrameworkIntranet.FormDefaults, {
     ...
     * @type Number
     */
    NUMBER_FIELD_WIDTH: 59,

    /** Ancho por defecto de los campos de texto
     * @type Number
     */
    VERY_LARGE_TEXT_FIELD_WIDTH: 654,

    /** Ancho por defecto de los campos de texto
     * @type Number
     */
    LARGE_TEXT_FIELD_WIDTH: 487,

    /** Ancho por defecto de los campos de texto
     * @type Number
     */
    TEXT_FIELD_WIDTH: 320,
     ...
     * @type Number
     */
    MEDIUM_TEXT_FIELD_WIDTH: 208,

    /** Ancho por defecto de los campos de texto
     * @type Number
     */
    SMALL_TEXT_FIELD_WIDTH: 152,

    /** Ancho por defecto de los campos de textarea
     * @type Number
     */
    SMALL_TEXTAREA_FIELD_WIDTH: 432,

    /** Ancho por defecto de los campos de textarea
     * @type Number
     */
    TEXTAREA_FIELD_WIDTH: 654,

    /** Alto por defecto de los campos de textarea
     * @type Number
     */
    TEXTAREA_FIELD_HEIGHT: 150,

    /** Ancho por defecto de los item selectors
     * @type Number
     */
    ITEMSELECTOR_FIELD_WIDTH: 318,
...
Ext.define("At4FrameworkIntranet.InspeccionBaseForm", {
	extend: "At4FrameworkIntranet.BasicForm",
    edificioHeaderLabel: "Edificio"
})
Ext.define("At4FrameworkIntranet.ImportIeeWindow", {
	...
	constructor: function (cfg) {
		...
		var form = Ext.create("At4FrameworkIntranet.ImportIeeForm");
...
Ext.define("At4FrameworkIntranet.ImportIeeForm", {
	...
	constructor: function (config) {
		...
		primerFormFields.documentoIee = Ext.create({
			//fieldLabel: "Documento IEE .iee",
			allowBlank: false,
			width: 500,
			margin: "0 30px",
			xtype: "filefield",
		...
		/*primerFormFields.submit = Ext.create({
			...
			handler: function () {
				...
				FormDataService.importIee(ieeInput, pdfInput, function (data, callee) {
					//console.log(data);
				});
				...
				At4FrameworkIntranet.FormDefaults.rows(
					[
						[{
							...
							html: "<span class='iee'><span class='icono iee'></span><span class='texto'>Documento IEE </span>(.iee)</span>"
						}],
						[primerFormFields.documentoIee],
						[{
							xtype: "container",
							margin: "15px 15px 0px 30px",
...
Ext.define("At4FrameworkIntranet.SubsanacioWindow", {
	...
	constructor: function (cfg) {
		...
		var form = Ext.create("At4FrameworkIntranet.SubsanacioForm");
		form.cancelarButton = Ext.create({
			text: "Cancelar",
			xtype: "button",
			handler: function (btn, ev) {
...
Ext.define("At4FrameworkIntranet.SubsanacioForm", {
	extend: "Ext.panel.Panel",
	layout: 'card',
	cls: "importariee",
	activeItem: 0, // index or id
	...
	constructor: function (config) {
		...
		/*primerFormFields.submit = Ext.create({
			...
			handler: function () {
				var ieeInput = this.primerFormFields.documentoIee.getTrigger("filebutton").component.fileInputEl.dom;
				var pdfInput = this.primerFormFields.documentoPdf.getTrigger("filebutton").component.fileInputEl.dom;
				FormDataService.subsanacio(ieeInput, pdfInput, function (data, callee) {
					//console.log(data);
				});
				//console.log('You clicked the button!');
			}
