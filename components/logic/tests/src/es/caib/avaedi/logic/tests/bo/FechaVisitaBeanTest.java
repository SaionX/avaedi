...
/**
 * Tests para el Bean: FechaVisita
 * @author agarcia@at4.net
 *
 */
public class FechaVisitaBeanTest extends InspeccionBaseBeanTests<FechaVisitaFormVO, FechaVisitaBO> {

	/**
	 * Bean para acceder a los métodos de negocio: FechaVisita
	 */
	@Autowired @Qualifier("FechaVisitaBean")
	protected FechaVisitaBO mainBean;

	/** Bean para acceder a los métodos de negocio: FechaVisita
	 */
	protected FechaVisitaBO getMainBean() {
...
*/
	...
	/**
	 * Rellena una instancia de FechaVisita aleatoriamente
	 */
	protected FechaVisitaFormVO fillRandomRecord(FechaVisitaFormVO record, boolean forUpdate) throws GenericBusinessException  {
		...
		record.setFecha( TestUtil.newString(255) );
