...
/**
 * Tests para el Bean: DocumentacionOtro
 * @author agarcia@at4.net
 *
 */
public class DocumentacionOtroBeanTest extends InspeccionBaseBeanTests<DocumentacionOtroFormVO, DocumentacionOtroBO> {

	/**
	 * Bean para acceder a los métodos de negocio: DocumentacionOtro
	 */
	@Autowired @Qualifier("DocumentacionOtroBean")
	protected DocumentacionOtroBO mainBean;

	/** Bean para acceder a los métodos de negocio: DocumentacionOtro
	 */
	protected DocumentacionOtroBO getMainBean() {
...
*/
	...
	/**
	 * Rellena una instancia de DocumentacionOtro aleatoriamente
	 */
	protected DocumentacionOtroFormVO fillRandomRecord(DocumentacionOtroFormVO record, boolean forUpdate) throws GenericBusinessException  {
		...
		record.setTexto( TestUtil.newString(255) );
