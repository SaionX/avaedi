 ...
 * 
 * <p>
 * Java class for bi complex type.
 * 
 * <p>
 ...
 *         &lt;element name="idcat" type="{http://www.catastro.meh.es/}idcat" minOccurs="0"/>
 ...
 *         &lt;element name="idad" type="{http://www.catastro.meh.es/}idad" minOccurs="0"/>
...
@XmlType(name = "bi", propOrder = { "idbi", "idcat", "idine", "idreg", "idbis", "rc", "idad", "tbi", "dt", "ldt", "inrbi", "debi", "dcbl", "spas", "rep", "lcol", "lcons", "evbi" })
@XmlSeeAlso({ Bireg.class, Birce.class, es.caib.avaedi.meh.catastro.Biccb.Bi.class })
public class Bi {

	protected Idbi idbi;
	protected Idcat idcat;
	 ...
	 * 
	 */
	public void setIdcat(Idcat value) {
		this.idcat = value;
	}
	 ...
	 * 
	 * @return possible object is {@link Idad }
	 * 
	 */
	public Idad getIdad() {
		return idad;
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Idad }
	 * 
	 */
	public void setIdad(Idad value) {
		this.idad = value;
	}
