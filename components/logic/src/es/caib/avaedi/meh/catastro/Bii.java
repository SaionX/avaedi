 ...
 * 
 * <p>
 * Java class for bii complex type.
 * 
 * <p>
 ...
 *         &lt;element name="idad" type="{http://www.catastro.meh.es/}idadi" minOccurs="0"/>
...
@XmlType(name = "bii", propOrder = { "idbi", "idcat", "idine", "idreg", "idbis", "rc", "idad", "tbi", "dt", "ldt", "inrbi", "debi", "dcbl", "spas", "sup", "rep", "lcol", "lcons", "evbi" })
public class Bii {
	 ...
	 * 
	 * @return possible object is {@link Idadi }
	 * 
	 */
	public Idadi getIdad() {
		return idad;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Idadi }
	 * 
	 */
	public void setIdad(Idadi value) {
		this.idad = value;
	}
