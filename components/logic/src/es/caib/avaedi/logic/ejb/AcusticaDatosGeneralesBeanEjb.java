...
import es.caib.avaedi.logic.bo.AcusticaDatosGeneralesBean;

/**
 * Ejb para tratar el formulario: AcusticaDatosGenerales
 * 
 * @author agarcia@at4.net
 * 
 */
@Stateless(mappedName = "es.caib.avaedi.logic.ejb.AcusticaDatosGeneralesBeanEjb")
@RolesAllowed("AED_ADMIN,AED_OPERADOR,AED_CONSULTA,AED_MUNICIPI")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class AcusticaDatosGeneralesBeanEjb extends AcusticaDatosGeneralesBean implements AcusticaDatosGeneralesBO {

	/**
	 * The logger object.
	 */
	private static Logger log = LogService.getLogger(AcusticaDatosGeneralesBeanEjb.class);
	...
	public void init() {
		...
		this.mainDao = new AcusticaDatosGeneralesDaoImpl(this.getSessionFactory());
	...
	public void destroy() {
		...
		((AcusticaDatosGeneralesDaoImpl) this.mainDao).setSessionFactory(null);
		this.mainDao = null;
