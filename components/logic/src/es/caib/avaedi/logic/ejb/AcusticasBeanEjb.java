...
import es.caib.avaedi.logic.bo.AcusticasBean;

/**
 * Ejb para tratar el formulario: Acusticas
 * 
 * @author agarcia@at4.net
 * 
 */
@Stateless(mappedName = "es.caib.avaedi.logic.ejb.AcusticasBeanEjb")
@RolesAllowed("AED_ADMIN,AED_OPERADOR,AED_CONSULTA,AED_MUNICIPI")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class AcusticasBeanEjb extends AcusticasBean implements AcusticasBO {

	/**
	 * The logger object.
	 */
	private static Logger log = LogService.getLogger(AcusticasBeanEjb.class);
	...
	public void init() {
		...
		this.mainDao = new AcusticasDaoImpl(this.getSessionFactory());
	...
	public void destroy() {
		...
		((AcusticasDaoImpl) this.mainDao).setSessionFactory(null);
		this.mainDao = null;
