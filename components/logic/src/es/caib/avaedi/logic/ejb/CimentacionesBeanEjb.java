...
import es.caib.avaedi.logic.bo.CimentacionesBean;

/**
 * Ejb para tratar el formulario: Cimentaciones
 * 
 * @author agarcia@at4.net
 * 
 */
@Stateless(mappedName = "es.caib.avaedi.logic.ejb.CimentacionesBeanEjb")
@RolesAllowed("AED_ADMIN,AED_OPERADOR,AED_CONSULTA,AED_MUNICIPI")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class CimentacionesBeanEjb extends CimentacionesBean implements CimentacionesBO {

	/**
	 * The logger object.
	 */
	private static Logger log = LogService.getLogger(CimentacionesBeanEjb.class);
	...
	public void init() {
		...
		this.mainDao = new CimentacionesDaoImpl(this.getSessionFactory());
	...
	public void destroy() {
		...
		((CimentacionesDaoImpl) this.mainDao).setSessionFactory(null);
		this.mainDao = null;
