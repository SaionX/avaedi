...
import es.caib.avaedi.logic.bo.AcusticaMejorasAcusticasBean;

/**
 * Ejb para tratar el formulario: AcusticaMejorasAcusticas
 * 
 * @author agarcia@at4.net 
 * 
 */
@Stateless(mappedName = "es.caib.avaedi.logic.ejb.AcusticaMejorasAcusticasBeanEjb")
@RolesAllowed("AED_ADMIN,AED_OPERADOR,AED_CONSULTA,AED_MUNICIPI")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class AcusticaMejorasAcusticasBeanEjb extends AcusticaMejorasAcusticasBean implements AcusticaMejorasAcusticasBO {

	/**
	 * The logger object.
	 */
	private static Logger log = LogService.getLogger(AcusticaMejorasAcusticasBeanEjb.class);
	...
	public void init() {
		...
		this.mainDao = new AcusticaMejorasAcusticasDaoImpl(this.getSessionFactory());
	...
	public void destroy() {
		...
		((AcusticaMejorasAcusticasDaoImpl) this.mainDao).setSessionFactory(null);
		this.mainDao = null;
