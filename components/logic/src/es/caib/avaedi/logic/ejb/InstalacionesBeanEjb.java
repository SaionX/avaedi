...
import es.caib.avaedi.logic.bo.InstalacionesBean;

/**
 * Ejb para tratar el formulario: Instalaciones
 * 
 * @author agarcia@at4.net
 * 
 */
@Stateless(mappedName = "es.caib.avaedi.logic.ejb.InstalacionesBeanEjb")
@RolesAllowed("AED_ADMIN,AED_OPERADOR,AED_CONSULTA,AED_MUNICIPI")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class InstalacionesBeanEjb extends InstalacionesBean implements InstalacionesBO {

	/**
	 * The logger object.
	 */
	private static Logger log = LogService.getLogger(InstalacionesBeanEjb.class);
	...
	public void init() {
		...
		this.mainDao = new InstalacionesDaoImpl(this.getSessionFactory());
	...
	public void destroy() {
		...
		((InstalacionesDaoImpl) this.mainDao).setSessionFactory(null);
		this.mainDao = null;
