...
/**
 * Bean negocio para tratar el formulario: Acusticas
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("AcusticasBean")
public class AcusticasBean extends InspeccionBaseBean<Acusticas, AcusticasListadoVO, AcusticasFormVO> implements AcusticasBO {

	public AcusticasBean() {
		super(Acusticas.class, AcusticasListadoVO.class, AcusticasFormVO.class);
	}
	...
	protected AcusticasDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected AcusticasDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<AcusticasListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<AcusticasListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<AcusticasListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de Acusticas con los datos recibidos de la capa de
	 * servicio
	 */
	protected Acusticas setFormData(AcusticasFormVO formData, Acusticas record) throws GenericBusinessException {

		if (record == null) {
			record = new Acusticas();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<Acusticas, AcusticasListadoVO> {

		@Override
		public AcusticasListadoVO transform(Acusticas instance, AcusticasListadoVO ret) {
		...
		@Override
		public AcusticasListadoVO transform(Acusticas instance) {
			if (instance == null) {
				return null;
			}
			AcusticasListadoVO ret = new AcusticasListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<Acusticas, AcusticasFormVO> {

		@Override
		public AcusticasFormVO transform(Acusticas instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<Acusticas, AcusticasFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<Acusticas, AcusticasListadoVO> listadoTransformer() {
