...
/**
 * Bean negocio para tratar el formulario: Instalaciones
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("InstalacionesBean")
public class InstalacionesBean extends InspeccionBaseBean<Instalaciones, InstalacionesListadoVO, InstalacionesFormVO> implements InstalacionesBO {

	public InstalacionesBean() {
		super(Instalaciones.class, InstalacionesListadoVO.class, InstalacionesFormVO.class);
	}
	...
	protected InstalacionesDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected InstalacionesDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<InstalacionesListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<InstalacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<InstalacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de Instalaciones con los datos recibidos de la capa
	 * de servicio
	 */
	protected Instalaciones setFormData(InstalacionesFormVO formData, Instalaciones record) throws GenericBusinessException {

		if (record == null) {
			record = new Instalaciones();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<Instalaciones, InstalacionesListadoVO> {

		@Override
		public InstalacionesListadoVO transform(Instalaciones instance, InstalacionesListadoVO ret) {
		...
		@Override
		public InstalacionesListadoVO transform(Instalaciones instance) {
			if (instance == null) {
				return null;
			}
			InstalacionesListadoVO ret = new InstalacionesListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<Instalaciones, InstalacionesFormVO> {

		@Override
		public InstalacionesFormVO transform(Instalaciones instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<Instalaciones, InstalacionesFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<Instalaciones, InstalacionesListadoVO> listadoTransformer() {
