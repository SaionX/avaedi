...
/**
 * Bean negocio para tratar el formulario: AcusticaMejorasAcusticas
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("AcusticaMejorasAcusticasBean")
public class AcusticaMejorasAcusticasBean extends InspeccionBaseBean<AcusticaMejorasAcusticas, AcusticaMejorasAcusticasListadoVO, AcusticaMejorasAcusticasFormVO> implements AcusticaMejorasAcusticasBO {

	public AcusticaMejorasAcusticasBean() {
		super(AcusticaMejorasAcusticas.class, AcusticaMejorasAcusticasListadoVO.class, AcusticaMejorasAcusticasFormVO.class);
	}
	...
	protected AcusticaMejorasAcusticasDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected AcusticaMejorasAcusticasDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<AcusticaMejorasAcusticasListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaMejorasAcusticasListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaMejorasAcusticasListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de AcusticaMejorasAcusticas con los datos recibidos
	 * de la capa de servicio
	 */
	protected AcusticaMejorasAcusticas setFormData(AcusticaMejorasAcusticasFormVO formData, AcusticaMejorasAcusticas record) throws GenericBusinessException {

		if (record == null) {
			record = new AcusticaMejorasAcusticas();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<AcusticaMejorasAcusticas, AcusticaMejorasAcusticasListadoVO> {

		@Override
		public AcusticaMejorasAcusticasListadoVO transform(AcusticaMejorasAcusticas instance, AcusticaMejorasAcusticasListadoVO ret) {
		...
		@Override
		public AcusticaMejorasAcusticasListadoVO transform(AcusticaMejorasAcusticas instance) {
			if (instance == null) {
				return null;
			}
			AcusticaMejorasAcusticasListadoVO ret = new AcusticaMejorasAcusticasListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<AcusticaMejorasAcusticas, AcusticaMejorasAcusticasFormVO> {

		@Override
		public AcusticaMejorasAcusticasFormVO transform(AcusticaMejorasAcusticas instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<AcusticaMejorasAcusticas, AcusticaMejorasAcusticasFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<AcusticaMejorasAcusticas, AcusticaMejorasAcusticasListadoVO> listadoTransformer() {
	...
	protected void normalizeFilters(Collection<FilterConfig> filters, PagingConfig pagingConfig) {
		...
		filterAssigments.put("mejorasOrden", "id.mejorasOrden");
		orderAssigments.put("mejorasOrden", "id#mejorasOrden");
		filterAssigments.put("claveInforme", "id.claveInforme");
		orderAssigments.put("claveInforme", "id#claveInforme");
