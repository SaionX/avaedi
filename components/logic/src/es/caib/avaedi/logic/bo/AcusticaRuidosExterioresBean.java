...
/**
 * Bean negocio para tratar el formulario: AcusticaRuidosExteriores
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("AcusticaRuidosExterioresBean")
public class AcusticaRuidosExterioresBean extends InspeccionBaseBean<AcusticaRuidosExteriores, AcusticaRuidosExterioresListadoVO, AcusticaRuidosExterioresFormVO> implements AcusticaRuidosExterioresBO {

	public AcusticaRuidosExterioresBean() {
		super(AcusticaRuidosExteriores.class, AcusticaRuidosExterioresListadoVO.class, AcusticaRuidosExterioresFormVO.class);
	}
	...
	protected AcusticaRuidosExterioresDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected AcusticaRuidosExterioresDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<AcusticaRuidosExterioresListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidosExterioresListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidosExterioresListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de AcusticaRuidosExteriores con los datos recibidos
	 * de la capa de servicio
	 */
	protected AcusticaRuidosExteriores setFormData(AcusticaRuidosExterioresFormVO formData, AcusticaRuidosExteriores record) throws GenericBusinessException {

		if (record == null) {
			record = new AcusticaRuidosExteriores();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<AcusticaRuidosExteriores, AcusticaRuidosExterioresListadoVO> {

		@Override
		public AcusticaRuidosExterioresListadoVO transform(AcusticaRuidosExteriores instance, AcusticaRuidosExterioresListadoVO ret) {
		...
		@Override
		public AcusticaRuidosExterioresListadoVO transform(AcusticaRuidosExteriores instance) {
			if (instance == null) {
				return null;
			}
			AcusticaRuidosExterioresListadoVO ret = new AcusticaRuidosExterioresListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<AcusticaRuidosExteriores, AcusticaRuidosExterioresFormVO> {

		@Override
		public AcusticaRuidosExterioresFormVO transform(AcusticaRuidosExteriores instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<AcusticaRuidosExteriores, AcusticaRuidosExterioresFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<AcusticaRuidosExteriores, AcusticaRuidosExterioresListadoVO> listadoTransformer() {
