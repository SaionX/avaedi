...
/**
 * Bean negocio para tratar el formulario: AcusticaRuidosInterioresUniones
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("AcusticaRuidosInterioresUnionesBean")
public class AcusticaRuidosInterioresUnionesBean extends InspeccionBaseBean<AcusticaRuidosInterioresUniones, AcusticaRuidosInterioresUnionesListadoVO, AcusticaRuidosInterioresUnionesFormVO> implements AcusticaRuidosInterioresUnionesBO {

	public AcusticaRuidosInterioresUnionesBean() {
		super(AcusticaRuidosInterioresUniones.class, AcusticaRuidosInterioresUnionesListadoVO.class, AcusticaRuidosInterioresUnionesFormVO.class);
	}
	...
	protected AcusticaRuidosInterioresUnionesDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected AcusticaRuidosInterioresUnionesDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<AcusticaRuidosInterioresUnionesListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidosInterioresUnionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidosInterioresUnionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de AcusticaRuidosInterioresUniones con los datos
	 * recibidos de la capa de servicio
	 */
	protected AcusticaRuidosInterioresUniones setFormData(AcusticaRuidosInterioresUnionesFormVO formData, AcusticaRuidosInterioresUniones record) throws GenericBusinessException {

		if (record == null) {
			record = new AcusticaRuidosInterioresUniones();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<AcusticaRuidosInterioresUniones, AcusticaRuidosInterioresUnionesListadoVO> {

		@Override
		public AcusticaRuidosInterioresUnionesListadoVO transform(AcusticaRuidosInterioresUniones instance, AcusticaRuidosInterioresUnionesListadoVO ret) {
		...
		@Override
		public AcusticaRuidosInterioresUnionesListadoVO transform(AcusticaRuidosInterioresUniones instance) {
			if (instance == null) {
				return null;
			}
			AcusticaRuidosInterioresUnionesListadoVO ret = new AcusticaRuidosInterioresUnionesListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<AcusticaRuidosInterioresUniones, AcusticaRuidosInterioresUnionesFormVO> {

		@Override
		public AcusticaRuidosInterioresUnionesFormVO transform(AcusticaRuidosInterioresUniones instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<AcusticaRuidosInterioresUniones, AcusticaRuidosInterioresUnionesFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<AcusticaRuidosInterioresUniones, AcusticaRuidosInterioresUnionesListadoVO> listadoTransformer() {
