...
/**
 * Bean negocio para tratar el formulario: Cimentaciones
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("CimentacionesBean")
public class CimentacionesBean extends InspeccionBaseBean<Cimentaciones, CimentacionesListadoVO, CimentacionesFormVO> implements CimentacionesBO {

	public CimentacionesBean() {
		super(Cimentaciones.class, CimentacionesListadoVO.class, CimentacionesFormVO.class);
	}
	...
	protected CimentacionesDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected CimentacionesDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<CimentacionesListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<CimentacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<CimentacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de Cimentaciones con los datos recibidos de la capa
	 * de servicio
	 */
	protected Cimentaciones setFormData(CimentacionesFormVO formData, Cimentaciones record) throws GenericBusinessException {

		if (record == null) {
			record = new Cimentaciones();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<Cimentaciones, CimentacionesListadoVO> {

		@Override
		public CimentacionesListadoVO transform(Cimentaciones instance, CimentacionesListadoVO ret) {
		...
		@Override
		public CimentacionesListadoVO transform(Cimentaciones instance) {
			if (instance == null) {
				return null;
			}
			CimentacionesListadoVO ret = new CimentacionesListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<Cimentaciones, CimentacionesFormVO> {

		@Override
		public CimentacionesFormVO transform(Cimentaciones instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<Cimentaciones, CimentacionesFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<Cimentaciones, CimentacionesListadoVO> listadoTransformer() {
	...
	protected void normalizeFilters(Collection<FilterConfig> filters, PagingConfig pagingConfig) {
		...
		filterAssigments.put("primaryLabel", "cimentacionprofundaTexto");
		orderAssigments.put("primaryLabel", "cimentacionprofundaTexto");
