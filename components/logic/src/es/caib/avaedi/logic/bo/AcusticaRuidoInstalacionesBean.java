...
/**
 * Bean negocio para tratar el formulario: AcusticaRuidoInstalaciones
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("AcusticaRuidoInstalacionesBean")
public class AcusticaRuidoInstalacionesBean extends InspeccionBaseBean<AcusticaRuidoInstalaciones, AcusticaRuidoInstalacionesListadoVO, AcusticaRuidoInstalacionesFormVO> implements AcusticaRuidoInstalacionesBO {

	public AcusticaRuidoInstalacionesBean() {
		super(AcusticaRuidoInstalaciones.class, AcusticaRuidoInstalacionesListadoVO.class, AcusticaRuidoInstalacionesFormVO.class);
	}
	...
	protected AcusticaRuidoInstalacionesDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected AcusticaRuidoInstalacionesDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<AcusticaRuidoInstalacionesListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidoInstalacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<AcusticaRuidoInstalacionesListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de AcusticaRuidoInstalaciones con los datos
	 * recibidos de la capa de servicio
	 */
	protected AcusticaRuidoInstalaciones setFormData(AcusticaRuidoInstalacionesFormVO formData, AcusticaRuidoInstalaciones record) throws GenericBusinessException {

		if (record == null) {
			record = new AcusticaRuidoInstalaciones();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<AcusticaRuidoInstalaciones, AcusticaRuidoInstalacionesListadoVO> {

		@Override
		public AcusticaRuidoInstalacionesListadoVO transform(AcusticaRuidoInstalaciones instance, AcusticaRuidoInstalacionesListadoVO ret) {
		...
		@Override
		public AcusticaRuidoInstalacionesListadoVO transform(AcusticaRuidoInstalaciones instance) {
			if (instance == null) {
				return null;
			}
			AcusticaRuidoInstalacionesListadoVO ret = new AcusticaRuidoInstalacionesListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<AcusticaRuidoInstalaciones, AcusticaRuidoInstalacionesFormVO> {

		@Override
		public AcusticaRuidoInstalacionesFormVO transform(AcusticaRuidoInstalaciones instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<AcusticaRuidoInstalaciones, AcusticaRuidoInstalacionesFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<AcusticaRuidoInstalaciones, AcusticaRuidoInstalacionesListadoVO> listadoTransformer() {
