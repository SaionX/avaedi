...
import es.caib.avaedi.common.persistence.HistoricoDao;
...
/**
 * Bean negocio para tratar el formulario: Historico
 * 
 * @author agarcia@at4.net
 * 
 */
@Repository("HistoricoBean")
public class HistoricoBean extends BaseBean<Historico, HistoricoListadoVO, HistoricoFormVO> implements HistoricoBO {

	public HistoricoBean() {
		super(Historico.class, HistoricoListadoVO.class, HistoricoFormVO.class);
	}
	...
	protected HistoricoDao mainDao;
	 ...
	 *            the bean to set
	 */
	protected HistoricoDao getMainDao() {
		return this.mainDao;
	}
	...
	@Override
	public ResultadoBusqueda<HistoricoListadoVO> findByInspeccion(int inspeccionId) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, null, null);
	}

	@Override
	public ResultadoBusqueda<HistoricoListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig) throws GenericBusinessException {
		return this.findByInspeccion(inspeccionId, pagingConfig, null);
	}

	@Override
	public ResultadoBusqueda<HistoricoListadoVO> findByInspeccion(int inspeccionId, PagingConfig pagingConfig, Collection<FilterConfig> filters) throws GenericBusinessException {
		if (filters == null) {
	...
	/**
	 * Rellena una instancia de Historico con los datos recibidos de la capa de
	 * servicio
	 */
	protected Historico setFormData(HistoricoFormVO formData, Historico record) throws GenericBusinessException {

		if (record == null) {
			record = new Historico();
		}
		try {
	...
	private class LvoTransformer implements ListadoTransformer<Historico, HistoricoListadoVO> {

		@Override
		public HistoricoListadoVO transform(Historico instance, HistoricoListadoVO ret) {
		...
		@Override
		public HistoricoListadoVO transform(Historico instance) {
			if (instance == null) {
				return null;
			}
			HistoricoListadoVO ret = new HistoricoListadoVO();
			return transform(instance, ret);
		}
	}

	private class FvoTransformer implements Transformer<Historico, HistoricoFormVO> {

		@Override
		public HistoricoFormVO transform(Historico instance) {
			if (instance == null) {
				return null;
			}
	 ...
	 */
	@Override
	public Transformer<Historico, HistoricoFormVO> formTransformer() {
	 ...
	 */
	@Override
	public ListadoTransformer<Historico, HistoricoListadoVO> listadoTransformer() {
