...
@Controller("inspeccionExportController")
public class InspeccionExportController extends AbstractController {
	...
	protected Map getModel(HttpServletRequest request) throws GenericBusinessException {
		...
		ResultadoExportacion resultadoExportacion = this.formDataService.getInspeccionExportacion(request);
